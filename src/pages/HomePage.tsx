    ...
    <div style={{ position: "relative", minHeight: "100vh", background: "#1a1a1a", overflowX: "hidden" }}>
      ...
      <div style={{ position: "relative", zIndex: 1, padding: "16px", paddingBottom: "100px" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "20px" }}>
          <div>
            <h1 style={{ fontSize: "24px", fontWeight: 700, color: "#fff", margin: 0 }}>ZENITH</h1>
        ...
        >
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <div style={{ textAlign: "center", flex: 1 }}>
              ...
              <div style={{ fontSize: "12px", color: "#a0a0a0", marginTop: "4px" }}>今日练习</div>
            </div>
            <div style={{ width: "1px", height: "40px", background: "rgba(255,255,255,0.1)" }} />
            <div style={{ textAlign: "center", flex: 1 }}>
              <div style={{ fontSize: "32px", color: "#00d4ff" }}><AnimatedNumber value={accuracy} suffix="%" /></div>
              <div style={{ fontSize: "12px", color: "#a0a0a0", marginTop: "4px" }}>正确率</div>
            </div>
            <div style={{ width: "1px", height: "40px", background: "rgba(255,255,255,0.1)" }} />
            <div style={{ textAlign: "center", flex: 1 }}>
              ...
              <div style={{ fontSize: "12px", color: "#a0a0a0", marginTop: "4px" }}>连续打卡</div>
            </div>
          </div>
        </motion.div>
        ...
        <div style={{ marginBottom: "20px" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "12px" }}>
            <h2 style={{ fontSize: "18px", fontWeight: 600, color: "#fff", margin: 0 }}>继续训练</h2>
            <button onClick={() => navigate("/library")} style={{ fontSize: "14px", color: "#00d4ff", background: "none", border: "none", cursor: "pointer", display: "flex", alignItems: "center", gap: "4px" }}>
            ...
            {quickStartBanks.length > 0 ? quickStartBanks.map((bank, i) => (
              ...
              >
                <div style={{ padding: "12px" }}>
                  <div style={{ fontSize: "14px", fontWeight: 600, color: "#fff", marginBottom: "4px", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
                    {bank.title}
                  </div>
                  <div style={{ fontSize: "12px", color: "#a0a0a0" }}>{bank.progress}% 完成</div>
                  <div style={{ marginTop: "6px", width: "100%", height: "3px", background: "#2a2a2a", borderRadius: "2px" }}>
                    <div style={{ width: `${bank.progress}%`, height: "100%", background: bank.color, borderRadius: "2px" }} />
                  </div>
                </div>
              </motion.div>
            )) : (
              <div style={{ color: "#666", fontSize: "14px", padding: "20px" }}>暂无进行中的题库</div>
            )}
          </div>
        </div>
        ...
        >
          <h2 style={{ fontSize: "16px", fontWeight: 600, color: "#fff", margin: "0 0 12px 0" }}>近7天趋势</h2>
              ...
              {recent7Days.map((d, i) => {
                ...
                return (
                  <div key={i} style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", gap: "4px" }}>
                    <div style={{ fontSize: "10px", color: "#a0a0a0" }}>{d.count}</div>
                    <div style={{ width: "100%", height: `${height}px`, background: "#00d4ff", borderRadius: "4px 4px 0 0", minHeight: "4px" }} />
                    <div style={{ fontSize: "10px", color: "#666" }}>{d.name}</div>
                  </div>
                );
              })}
            </div>
          ) : (
            <div style={{ color: "#666", fontSize: "14px", textAlign: "center", padding: "20px" }}>暂无数据</div>
          )}
        </motion.div>
